...
const Contact: React.FC = () => {
  ...
  if (isSubmitted) {
    return (
      <section id="contact" className="py-12 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-slate-800 dark:to-slate-900 transition-colors duration-300">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 p-4 bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/20">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-slate-300">sherpa.sjs@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/20">
                ...
                <div>
                  <h4 className="text-gray-900 dark:text-white font-semibold">LinkedIn</h4>
                  <a 
                    href="https://linkedin.com/in/sonamjsherpa" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-gray-600 dark:text-slate-300 hover:text-blue-600 dark:hover:text-white transition-colors duration-300"
                  >
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/20">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-slate-300">Within 24-48 hours</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4 p-4 bg-white/80 dark:bg-white/10 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-white/20">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-slate-300">Sonoma County, CA</p>
                </div>
              </div>
            </div>
          </div>
